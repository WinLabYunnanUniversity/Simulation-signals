%循环1000次，获取数据DVB-T:76—84MHz
tic; 
Fs=9.14e6;
% test = ori_sig(1:200000,1);
test = ori_sig(1+32000*3:32000+32000*3,1);
...
for k=1:1000
    ...
    ylim([-120,20]);
    xlim([76,84]);
    set(gca,'xtick',76:0.8:84)
    sig(k,:)=new_sig;%数据拼接
    k1=k-1;
    filename=['image\6.28mp4\DVB\',num2str(k1),'.png'];
    saveas(gcf,filename)
end
save('dataset\DVB1.mat','sig');
